...
### Selbsteinschätzung
Das Modul ist ein sehr wichtiger Bestandteil meiner Ausbildung. Es ist auch ein sehr grosses Thema worin sehr viele Aspekte zu beachten sind. Nach der Erarbeitung dieses Moduls, habe ich sehr viele Kenntnisse gewonnen, welche meine Arbeit als Informatiker sicherer machen wird. Die wesentlichen Kompetenzen habe ich erreicht. Als Resultat davon, werden meine zukünftigen Projekte und Applikationen mit Sicherheit als Standard implementiert. <br>
Trotz meiner vielen Kenntnisse, habe noch nicht alles beherrscht. Das ist natürlich bei so einem riesigen, stets weiterentwickelenden Thematik schwer. Man kann es nie komplett beherrschen, denn Hacker finden jeden Tag neue Wege Applikationen anzugreifen. Nichtdestotrotz bin ich jetzt vorbereitet die verbreitesten Methoden vorzubeugen.
