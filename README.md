...
| A06:2021-Vulnerable and Outdated Components| Veraltete/unsichere Komponenten werden verwendet (viele Schwachstellen) | - Regelmässige Überprüfung und Aktualisierung von Komponenten. <br> - Softwarekomponenten mit geringem Risiko verwenden (offizielle Quellen / regelmässige Patches).                                                                                                                                                          |
| A07:2021-Identification and Authentication Failures | Automatisierte Angriffe wie Brute-Force-Angriffe werden nicht vorgebeugt & unsorgfältiger Umgang mit Passwörtern | - Multifaktor-Authentifizierung verwenden. <br> - Vorgaben für Passwörter festlegen. <br> - Wiederholte Login-Versuche einschränken.                                                                                                                                                                                                                               |
| A08:2021-Software and Data Integrity Failures | Automatisierte Aktualisierung beinhaltet keine Integritätsprüfung & ermöglicht somit die Publizierung von Anwendungen mit Sicherheitslücken. | - Die Integrität von Softwareupdates und kritischen Daten verifizieren. <br> - CI/CD-Pipelines auf Integritätsprobleme bewachen.                                                                                                                                                                                                |
| A09:2021-Security Logging and Monitoring Failures | Erreignisse werden nicht gelogged bzw. überwacht | - Umfassend Loggen und Bewachen. <br> - Logs auf Anomalien überprüfen. <br> - Security Information and Event Management (SIEM)-Lösungen verwenden.                                                                                                                                                                                                                              |
| A10:2021-Server-Side Request Forgery      | HTTP wird verwendet um ungesicherte Daten anzufordern | - Filtern und Validierungen für benutzerseitige Anfragen verwenden. <br> - Web Application Firewalls (WAF) einsetzen. <br> - Keine rohe Daten an Benutzern senden                                                |
